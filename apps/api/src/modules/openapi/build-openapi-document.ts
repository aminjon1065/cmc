...
const RESPONSE_SCHEMA: Record<string, string> = {
  ...
  "get /v1/imports": "ImportJobsListResponse",
  "get /v1/imports/{id}": "ImportJobResponse",
  "get /v1/imports/{id}/errors": "ImportRowErrorsListResponse",
  // chat (P3.12)
  "get /v1/chat/channels": "ChatChannelsListResponse",
  "post /v1/chat/channels": "ChatChannelResponse",
  "get /v1/chat/channels/{id}": "ChatChannelResponse",
  "get /v1/chat/channels/{id}/messages": "ChatMessagesListResponse",
  "post /v1/chat/channels/{id}/messages": "ChatMessageResponse",
  "get /v1/chat/messages/{id}/replies": "ChatMessagesListResponse",
  "patch /v1/chat/messages/{id}": "ChatMessageResponse",
  "post /v1/chat/messages/{id}/reactions": "ChatMessageResponse",
  // audit chain
